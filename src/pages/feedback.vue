        ...
        <div class="main__feedback">
          ...
          <!-- <section class="feedback__row">
            ...
            <div class="feedback__note">
              バグ報告の場合はエラー画面のスクリーンショットをいただけると幸いです。
            </div>
            <InputButtonFile
              name="csv-file"
          ...
          >
            ...
            <TextFieldSingleLine v-model="email"></TextFieldSingleLine>
          </section>
        </div>
      </div>
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const placeholder = {
      バグの報告:
        "例）授業の検索ページで「XXXX」という授業を追加しようとしたら、「OOOO」というエラーメッセージが出てきて追加できませんでした。",
      新機能の要望:
    ...
    const emailNote = {
      バグの報告:
        "より詳しい原因解明のため開発チームから連絡を差し上げる場合がございます。ご協力いただける場合はメールアドレスをご記入ください。",
    ...
    const sendFeedback = () => {
      ...
      axios
        ...
        .catch(() => {
          displayToast(ports)(
            "申し訳ございません。送信に失敗しました。ネットワーク環境をご確認ください。"
          );
        });
    };
