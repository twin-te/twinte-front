...
export const validateCourse = (registeredCource: Required<RegisteredCourse>): Required<RegisteredCourse> => {
  const attendance = registeredCource.attendance < 0 ? 0 : registeredCource.attendance;
