      ...
      users: {
        me: {
          ...
          patch: (option: {
            ...
            >(prefix, PATH8, PATCH, option).json(),
          /**
           * @returns 成功
           */
          $patch: (option: {
        ...
        return {
          ...
          $put: (option: {
            ...
            >(prefix, prefix1, PUT, option)
              ...
              .then((r) => r.body),
          delete: (option?: { config?: T | undefined } | undefined) =>
            fetch<void, BasicHeaders, Methods14["delete"]["status"]>(
              prefix,
              prefix1,
              DELETE,
              option
        ...
        return {
          ...
          $put: (option: {
            ...
            >(prefix, prefix1, PUT, option)
              ...
              .then((r) => r.body),
          delete: (option?: { config?: T | undefined } | undefined) =>
            fetch<void, BasicHeaders, Methods18["delete"]["status"]>(
              prefix,
              prefix1,
              DELETE,
              option
